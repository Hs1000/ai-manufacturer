...
function PredictionDashboard() {
  ...
  return (
    <DashboardContainer title="AI Breach Prediction Dashboard">
      <div
        style={{
          display: "grid",
      ...
      >
        <Card title="High Risk" value={summary.high} color="#dc2626" />
        <Card title="Medium Risk" value={summary.medium} color="#d97706" />
            ...
            <tbody>
              {predictions.map((item) => (
                <tr key={item.order_id}>
                  ...
                  <td style={tdStyle}>{item.lens_type}</td>
                  <td style={tdStyle}>{item.status}</td>
                  <td style={tdStyle}>
                    {Math.round(item.breach_probability * 100)}%
                  </td>
                  <td style={tdStyle}>
